...
Note:
	...
	The gpiozero library will only work on a raspberry pi, 
	and the implementation of this code cannot be completed until I create some hardware devices for the pi.
	Notify my of any errors generated by this code, but ignore any warnings, as the warnigs are expected.